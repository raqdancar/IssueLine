...
function TimelineIssueCardDetailed({
  ...
  const { seriesName, number, volume, publicationDate, price, pageCount, editing, rating } = meta
  ...
  return (
    <li id={entryDomId} className="relative pl-9">
      ...
      <article
        ...
        className={`rounded-xl border ${severityVariant.panel} p-3 transition hover:-translate-y-0.5 ${articleEmphasis}`}
        style={gradientStyle}
      >
